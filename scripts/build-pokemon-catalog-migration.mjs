...
if (!["red", "blue", "yellow", "gold", "silver", "crystal", "ruby", "sapphire", "emerald", "firered", "leafgreen", "diamond", "pearl", "platinum", "heartgold", "soulsilver", "black", "white", "black-2", "white-2"].includes(game)) throw new Error("The reviewed migration builder accepts only supported Generation I–V games.");
...
const independentSources = Number(payload.game.generation) === 5 ? "Veekun and PKHeX/PKHeX" : `Veekun and pret/${pretRepository}`;
