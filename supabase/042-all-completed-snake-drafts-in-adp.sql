-- Community ADP uses every completed snake draft, including private,
-- practice, and points-budget snake drafts. Auction and incomplete drafts
-- remain excluded because they would make draft-position averages misleading.
