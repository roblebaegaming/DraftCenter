-- Atomically archive the current snapshot and clear official draft rows.
...
revoke all on function public.transition_league_to_new_season(uuid, jsonb)
  from public, anon, authenticated;
grant execute on function public.transition_league_to_new_season(uuid, jsonb)
  to authenticated;
