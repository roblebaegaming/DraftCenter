const SAFE_TOURNAMENT_MESSAGES = new Set([
  ...
  "Sign in to delete a tournament.",
  "Only the tournament owner can delete it.",
  "The tournament changed. Refresh before deleting it.",
  "Live tournaments cannot be deleted. Finish the event first.",
  "Connected championships must be managed from the organization workspace.",
