...
const COPY = {
  ...
  fr: {
    eyebrow: "COMMUNAUTÉ DES WORLDS", title: "Chat des Worlds en français", description: "Discutez de vos pronostics avec d’autres membres de DraftCenter dans cet espace francophone. Tout le monde participe à la même compétition des Worlds.", loadingAccount: "Vérification de votre compte DraftCenter…", signInTitle: "Connectez-vous pour lire et rejoindre le chat des Worlds.", signInBody: "Les messages restent dans la communauté des membres. Un compte DraftCenter gratuit est nécessaire pour lire ou publier.", signInAction: "Se connecter ou créer un compte", loading: "Chargement des messages récents…", empty: "Aucun message pour le moment. Lancez la discussion sur vos pronostics.", loadEarlier: "Charger les messages précédents", refresh: "Actualiser", placeholder: "Partagez un pronostic ou posez une question…", characters: (count) => `${count}/500 caractères`, post: "Publier", posting: "Publication…", remove: "Supprimer", removeConfirm: "Supprimer votre message du chat des Worlds ?", report: "Signaler", reported: "Signalé", rules: "Restez accueillant et concentrez-vous sur les pronostics. Ne partagez pas d’informations privées et ne ciblez personne.", loadError: "Le chat des Worlds n’a pas pu être chargé. Essayez de l’actualiser.", postError: "Votre message n’a pas pu être publié.", removeError: "Votre message n’a pas pu être supprimé.", reportError: "Le message n’a pas pu être signalé.", rateLimit: "Veuillez patienter un instant avant de publier à nouveau.",
  },
  de: {
