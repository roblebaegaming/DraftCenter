...
const COPY = {
  ...
  es: {
    language: "Idioma", indexTitle: "Pokédex Pokémon en español", indexBody: "Consulta todas las especies Pokémon con su nombre oficial en español. Abre un perfil para ver datos de la Pokédex, habilidades, tipos, estadísticas y medidas localizados.", generation: (number) => `Generación ${number}`, species: (count) => `${count} especies`, back: "← Pokédex en español", englishProfile: "Perfil completo en inglés", abilities: "Habilidades", hidden: "Oculta", stats: (name) => `Estadísticas base de ${name}`, total: "Total de estadísticas base", measurements: (name) => `Medidas de la Pokédex de ${name}`, height: "Altura", weight: "Peso", nationalDex: "Pokédex Nacional", introduced: "Introducción", draftTitle: "Análisis de DraftCenter", draftBody: "Esta primera fase multilingüe incluye los nombres oficiales de los Pokémon y los datos principales de la Pokédex. Los resultados competitivos, las estadísticas de la comunidad, los movimientos y el análisis de draft siguen por ahora en el perfil completo en inglés.", openEnglish: "Abrir el perfil completo en inglés", sources: "Fuentes y estado de la traducción", sourceBody: "Los nombres de los Pokémon y los datos principales de la Pokédex proceden del catálogo fijado de PokéAPI de DraftCenter. El texto de la página se localiza por separado para que una actualización de idioma nunca cambie la identidad del Pokémon ni los resultados de los cuadros.", fallbackForm: "Esta forma todavía no tiene un nombre revisado en español, así que se muestra temporalmente su nombre en inglés.", fallbackEntry: (name) => `Descubre a ${name} y su perfil principal de la Pokédex.`, type: "tipo", title: (name) => `${name}: Pokédex, estadísticas y habilidades`, description: (name, types) => `Perfil de la Pokédex de ${name} en español: tipo ${types}, habilidades, estadísticas base, medidas y datos Pokémon oficiales.`, notFound: "Pokémon no encontrado",
  },
  fr: {
    language: "Langue", indexTitle: "Pokédex Pokémon en français", indexBody: "Parcourez toutes les espèces de Pokémon avec leur nom officiel en français. Ouvrez un profil pour consulter les informations du Pokédex, les talents, les types, les statistiques et les mensurations en français.", generation: (number) => `Génération ${number}`, species: (count) => `${count} espèces`, back: "← Pokédex en français", englishProfile: "Profil complet en anglais", abilities: "Talents", hidden: "Caché", stats: (name) => `Statistiques de base de ${name}`, total: "Total des statistiques de base", measurements: (name) => `Mensurations Pokédex de ${name}`, height: "Taille", weight: "Poids", nationalDex: "Pokédex National", introduced: "Première apparition", draftTitle: "Analyse DraftCenter", draftBody: "Cette première phase multilingue couvre les noms officiels des Pokémon et les informations essentielles du Pokédex. Les résultats compétitifs, les statistiques de la communauté, les capacités et l’analyse de draft restent pour le moment sur le profil complet en anglais.", openEnglish: "Ouvrir le profil complet en anglais", sources: "Sources et état de la traduction", sourceBody: "Les noms des Pokémon et les informations essentielles du Pokédex proviennent du catalogue PokéAPI épinglé par DraftCenter. Le texte de la page est localisé séparément afin qu’une mise à jour linguistique ne modifie jamais l’identité d’un Pokémon ni les résultats d’un tableau.", fallbackForm: "Cette forme ne possède pas encore de nom vérifié en français ; son nom anglais est donc affiché temporairement.", fallbackEntry: (name) => `Découvrez ${name} et son profil Pokédex essentiel.`, type: "type", title: (name) => `${name} : Pokédex, statistiques et talents`, description: (name, types) => `Profil Pokédex de ${name} en français : type ${types}, talents, statistiques de base, mensurations et données Pokémon officielles.`, notFound: "Pokémon introuvable",
  },
  de: {
