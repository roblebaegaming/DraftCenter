...
export default function PublicBracketBuilder() {
  ...
  return <main className="public-bracket-studio">
    <section className="public-bracket-hero">
      ...
      <div className="public-bracket-hero-actions"><a className="primary-button inline-link-button" href="#bracket-workspace">Start building</a><a className="quiet-button" href="/tournaments/predictions">Join live predictions</a><a className="quiet-button" href="/tools/mega-bracket">Play the Pokémon Mega Bracket</a></div>
