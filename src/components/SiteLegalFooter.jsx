export default function SiteLegalFooter() {
  return <footer className="site-legal-footer">
    <nav><a href="/resources">Resources</a><a href="/my-teams">My Teams</a><a href="/legal">Legal, Privacy & Community Rules</a><a href="/legal#intellectual-property">Intellectual Property</a><a href="/legal#third-party-services">Connected Services</a></nav>
