...
export default function WorldsTcgPickSixteenSetup({ sourceRegistry }) {
  ...
  return <main className="worlds-shell worlds-tcg-setup">
    <nav className="worlds-game-switcher" aria-label="2026 Worlds prediction games">
      <Link href="/worlds/2026">VGC Masters <small>Live</small></Link>
      <span aria-current="page">TCG Masters <small>In build</small></span>
    </nav>
    ...
    <section className="worlds-hero worlds-tcg-hero">
      <div>
        ...
        <div className="worlds-hero-actions">
          ...
          <Link className="quiet-button" href="/worlds/2026">Play VGC Pick 16</Link>
        </div>
      </div>
