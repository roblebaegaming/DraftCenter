...
export default function ResourcesPage() {
  return <main className="resources-shell">
    <nav className="public-page-nav"><a className="quiet-button" href="/">DraftCenter</a><a className="quiet-button" href="/tools/team-builder">Draft Lab</a><a className="quiet-button" href="/tools/mega-bracket">Mega Bracket</a><a className="quiet-button" href="/explore">Community</a><a className="quiet-button" href="/pokemon">Pokémon</a></nav>
    ...
    <div className="resource-sections"><section className="resource-section"><h2>DraftCenter learning library</h2><div className="resource-grid"><a href="/tools/team-builder"><strong>Draft Lab team builder</strong><p>Build a six-Pokémon team or 24-Pokémon draft roster, then review type coverage, Speed tiers, stat balance, and base format legality.</p><span>Open Draft Lab →</span></a><a href="/tools/mega-bracket"><strong>Mega Bracket Full Dex Challenge</strong><p>Compare all 1,162 supported Pokémon and forms, reveal your Top 64, and save your personal champion.</p><span>Start Mega Bracket →</span></a><a href="/nuzlocke"><strong>Nuzlocke Run Tracker</strong><p>Build a run from verified encounters, then track every route, catch, loss, milestone, level cap, and note privately.</p><span>Open the run tracker →</span></a><a href="/resources/daily-games"><strong>Pokémon Daily Games</strong><p>Play Pokémon Connections, the community poll, draft bracket, and quiz, then explore more independent daily games.</p><span>Open the daily hub →</span></a><a href="/guides"><strong>Commissioner and coach guides</strong><p>Learn league setup, draft methods, tier lists, schedules, transactions, and playoffs.</p><span>Browse guides →</span></a><a href="/formats"><strong>Format library</strong><p>Compare Pokémon Champions, Scarlet and Violet, Sword and Shield, VGC, and custom formats.</p><span>Browse formats →</span></a></div></section></div>
