...
export default function ResourcesPage() {
  return <main className="resources-shell">
    ...
    <div className="resource-sections"><section className="resource-section"><h2>DraftCenter learning library</h2><div className="resource-grid"><a href="/tools/team-builder"><strong>Draft Lab team builder</strong><p>Build a six-Pokémon team or 24-Pokémon draft roster, then review type coverage, Speed tiers, stat balance, and base format legality.</p><span>Open Draft Lab →</span></a><a href="/tools/mega-bracket"><strong>Mega Bracket Full Dex Challenge</strong><p>Compare all 1,162 supported Pokémon and forms, reveal your Top 64, and save your personal champion.</p><span>Start Mega Bracket →</span></a><a href="/nuzlocke"><strong>Nuzlocke Run Tracker</strong><p>Build a verified run and track every encounter, with cave floors and subareas sharing their parent location’s slot.</p><span>Open the run tracker →</span></a><a href="/resources/daily-games"><strong>Pokémon Daily Games</strong><p>Play Pokémon Connections, the community poll, bracket, and quiz, then return Sunday for the weekly Super Bracket.</p><span>Open the daily hub →</span></a><a href="/guides"><strong>Commissioner and coach guides</strong><p>Learn league setup, draft methods, tier lists, schedules, transactions, and playoffs.</p><span>Browse guides →</span></a><a href="/formats"><strong>Format library</strong><p>Compare Pokémon Champions, Scarlet and Violet, Sword and Shield, VGC, and custom formats.</p><span>Browse formats →</span></a></div></section></div>
