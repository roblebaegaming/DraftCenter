...
return (
  <main className="hub-shell">
    ...
    <section className="hub-home-tools" aria-labelledby="hub-home-tools-title"><div><span className="eyebrow">TEAM-BUILDING TOOL</span><h2 id="hub-home-tools-title">Team Lab</h2><p>Build a 6- or 10-Pokémon roster, connect saved teams, write private notes, plan opponent matchups, and check coverage, legality, and common meta archetypes.</p></div><a className="secondary-button inline-link-button" href="/tools/team-builder">Open Team Lab</a></section>
  </main>
);
}
