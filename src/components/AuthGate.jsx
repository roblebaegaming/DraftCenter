...
function LeagueTools({ league, onClose, onUpdated }) {
  ...
  return <div className="modal-backdrop">
    <section className="tools-modal">
      ...
      <p className="muted">They must already have joined as a manager and created a DraftCenter username.</p>
      <div className="form-stack"><label>Username<input value={coUsername} onChange={(e)=>setCoUsername(e.target.value.toLowerCase())} placeholder="coach_username" /></label><button type="button" className="secondary-button" disabled={busy} onClick={promoteCo}>Make co-commissioner</button></div>
