...
class LeagueErrorBoundary extends Component {
  ...
  componentDidCatch(error) {
    ...
    this.props.supabase.rpc("report_operational_issue", {
      p_kind: "client_runtime_error",
      p_message: error?.message || "Unknown league-screen error",
      p_league_id: this.props.leagueId,
      p_context: {
