...
export default function AuthGate(){
  ...
  async function signInWithDiscord(){setBusy(true);setMessage('');const {error}=await supabase.auth.signInWithOAuth({provider:'discord',options:{redirectTo:authCallbackUrl(window.location.origin)}});if(error){setBusy(false);setMessage(errorText(error,'Discord sign-in could not start. Please try again.'));}}
