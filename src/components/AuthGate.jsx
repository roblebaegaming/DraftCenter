...
import { authCaptchaRequired, authCaptchaTokenOptions } from "../lib/authCaptcha";
...
function PublicLanding({ email, password, setEmail, setPassword, busy, message, onSubmit, onMode, captchaReady, captchaResetKey, onCaptchaToken }) {
