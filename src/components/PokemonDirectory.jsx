  ...
  return <main className="pokemon-directory pokemon-directory-wide">
    ...
    <section className="pokemon-directory-layout">
      <aside className="pokemon-search-card pokemon-browser-card">
        ...
        <fieldset className="pokemon-trait-filters"><legend>Pokédex traits</legend><label>Color<select value={props.color} onChange={(event) => props.setColor(event.target.value)}><option value="">All colors</option>{POKEMON_COLOR_OPTIONS.map((item) => <option key={item.id} value={item.id}>{item.label}</option>)}</select></label><label>Egg Group<select value={props.eggGroup} onChange={(event) => props.setEggGroup(event.target.value)}><option value="">All Egg Groups</option>{POKEMON_EGG_GROUP_OPTIONS.map((item) => <option key={item.id} value={item.id}>{item.label}</option>)}</select></label><label>Shape<select value={props.shape} onChange={(event) => props.setShape(event.target.value)}><option value="">All shapes</option>{POKEMON_SHAPE_OPTIONS.map((item) => <option key={item.id} value={item.id}>{item.label}</option>)}</select></label></fieldset>
