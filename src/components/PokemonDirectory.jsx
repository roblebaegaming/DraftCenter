...
function PokemonDirectoryContent() {
  ...
  return <WidePokemonDirectory {...{ query, setQuery, type, setType, generation, setGeneration, resultLimit, setResultLimit, ability, setAbility, findAbility, clearFilters, results, selected, choose, dexNumbers, statLookup, sortBy, sortDirection, toggleSort, loading, message, details, species, uniqueEntries, regulationStatus, sourceData, activeSource, recommendedSource, moveCategory, setMoveCategory, moveQuery, setMoveQuery, setMoveSource, visibleMoves, groupedMoves, selectedMove, inspectMove, setSelectedMove, loadingMove, loadingMoveCategories, inspectedMove, pollPlacements, draftProfile }} />;
