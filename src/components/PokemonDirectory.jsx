...
function PokemonDirectoryContent() {
  ...
  const filteredPokemon = useMemo(() => POKEMON_DIRECTORY.filter((pokemon) => {
    ...
    return matchName && matchType && matchGen && matchColor && matchEggGroup && matchShape && matchAbility;
  }), [query, type, generation, color, eggGroup, shape, abilityMatches, dexNumbers, dexSearchName]);
  ...
  function clearFilters() { setQuery(""); setType(""); setGeneration(""); setColor(""); setEggGroup(""); setShape(""); setSortBy("name"); setAbility(""); setAbilityMatches(null); setMessage(""); }
