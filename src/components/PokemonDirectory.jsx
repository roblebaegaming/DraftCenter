...
function WidePokemonDirectory(props) {
  ...
  return <main className="pokemon-directory pokemon-directory-wide">
    <header className="pokemon-directory-header"><a href="/?view=dashboard" className="quiet-button">← DraftCenter home</a><div><span className="eyebrow">POKEMON</span><h1>Explore the Pokedex</h1><p className="muted">A stat-first Pokémon browser. Sort any column, select a Pokémon, and study its full game information on the right.</p></div></header>
