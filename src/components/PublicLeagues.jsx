...
export default function PublicLeagues({ initialLeagues = [] }) {
  ...
  return <main className="league-directory-shell">
    ...
    <section className="explore-card">
      <h2>Join a roster or follow from the sideline</h2>
      <p>An open league is accepting managers for available teams. A watchable league keeps its competitive spots closed while publishing season information for spectators. Open a league page to review its description, format, standings, official draft board, schedule, results, replays, predictions, and playoff field when the commissioner has published them.</p>
      <p>Before joining, read the league&apos;s own rules for battle format, roster size, draft method, transaction limits, deadlines, and activity expectations. DraftCenter provides the workflow, but commissioners define and enforce the competition. You can browse without occupying a team and sign in only when you are ready to join or manage a league.</p>
    </section>
