...
export default function SiteQuickLinks() {
  ...
  return <nav className="site-quick-links" aria-label="Account and resources">{isOwner && <><a href="/operations">Operations</a><a href="/operations/daily-three">Daily Three</a></>}<a href="/resources/daily-games">Daily Games</a><a href="/nuzlocke">Nuzlockes</a><a href="/tournaments">Tournaments</a>{signedIn&&<a href="/trainer-dex">Trainer Dex</a>}<a href="/my-teams">My Teams</a><a href="/manuals">Help</a>{signedIn && <button type="button" onClick={signOut}>Sign out</button>}</nav>;
}
