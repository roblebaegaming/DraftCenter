...
export default function SiteQuickLinks() {
  ...
  return <nav className="site-quick-links" aria-label="Account and resources">{isOwner && <><a href="/operations">Operations</a><a href="/operations/daily-three">Daily Three</a></>}<a href="/tournaments">Tournaments</a><a href="/nuzlocke">Nuzlocke Lab</a><a href="/my-teams">My Teams</a><a href="/manuals">Help</a><a href="/resources">Resources</a><a href="/support">Support DraftCenter</a>{signedIn && <button type="button" onClick={signOut}>Sign out</button>}</nav>;
}
