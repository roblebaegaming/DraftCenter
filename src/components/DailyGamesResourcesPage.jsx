...
export default function DailyGamesResourcesPage() {
  ...
  return <main className="resources-shell daily-resources-shell">
    ...
    <header className="resources-hero"><span className="eyebrow">NEW POKÉMON GAMES EVERY DAY</span><h1>Pokémon Daily Games</h1><p>Find today’s Roster Connections, then complete DraftCenter’s community Daily Three: vote in the poll, crown a bracket champion, and solve the Pokémon quiz.</p><div className="explore-actions"><a className="primary-button" href="#daily-three">Play today’s games</a><ShareButton title="Pokémon Daily Games" text="Play Roster Connections and the Pokémon Daily Three on DraftCenter." /></div></header>
    ...
    <section className="daily-games-seo-content"><span className="eyebrow">PLAY, COMPARE, RETURN TOMORROW</span><h2>Free daily Pokémon games for fans and draft-league players</h2><p>DraftCenter’s Pokémon dailies combine a four-group Roster Connections puzzle with a community question, a head-to-head Pokémon bracket, and a daily Pokémon quiz. A new set appears each day using your local calendar date.</p><div><article><h3>Daily Pokémon poll</h3><p>Choose your answer before seeing how the community voted.</p></article><article><h3>Daily draft bracket</h3><p>Advance eight Pokémon through seven matchups and compare your champion.</p></article><article><h3>Daily Pokémon quiz</h3><p>Identify a Pokémon from a rotating clue and check the community results.</p></article></div><h2>Pokémon dailies FAQ</h2><details><summary>Are the Pokémon daily games free?</summary><p>Yes. Roster Connections is public and saves progress only in this browser. A free DraftCenter account is required to submit the community Daily Three and save those results.</p></details><details><summary>When do the daily Pokémon games reset?</summary><p>Roster Connections, the poll, bracket, and quiz use your local calendar date, so fresh games appear each day.</p></details><details><summary>What is the Pokémon Daily Three?</summary><p>It is one community poll, one eight-Pokémon draft bracket, and one Pokémon quiz released each day. Roster Connections is an additional public daily game.</p></details></section>
