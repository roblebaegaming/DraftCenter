...
export default function DailyGamesResourcesPage() {
  ...
  return <main className="resources-shell daily-resources-shell">
    ...
    <header className="resources-hero"><span className="eyebrow">NEW POKÉMON GAMES EVERY DAY</span><h1>Pokémon Daily Games</h1><p>Play Pokémon Connections, vote in the community poll, crown a bracket champion, and solve the daily Pokémon quiz.</p><div className="explore-actions"><a className="primary-button" href="#daily-games">Play today’s games</a><ShareButton title="Pokémon Daily Games" text="Play four fresh Pokémon Daily Games on DraftCenter." /></div></header>
    <section id="daily-games" className="daily-games-play"><div className="daily-games-heading"><div><span className="eyebrow">TODAY’S DAILY GAMES</span><h2>Four fresh Pokémon challenges</h2></div><p>Complete all four to grow your streak and earn Daily Games badges. Eligible choices also add discoveries to your Trainer Dex.</p></div><div className="daily-trio-grid"><PollOfTheDay supabase={supabase}/><DailyCommunityGames signedIn={signedIn} standalone/></div></section>
    <RosterConnections signedIn={signedIn} />
    ...
    <section className="daily-games-seo-content"><span className="eyebrow">PLAY, COMPARE, RETURN TOMORROW</span><h2>Free daily Pokémon games for fans and draft-league players</h2><p>DraftCenter’s four Pokémon Daily Games combine a Connections puzzle with a community poll, a head-to-head Pokémon bracket, and a daily Pokémon quiz. A fresh set appears each day using your local calendar date.</p><div><article><h3>Pokémon Connections</h3><p>Sort 16 Pokémon into groups using strategy, measurements, shape, Egg Group, and other shared facts.</p></article><article><h3>Daily Pokémon poll</h3><p>Choose your answer before seeing how the community voted.</p></article><article><h3>Daily draft bracket</h3><p>Advance eight Pokémon through seven matchups and compare your champion.</p></article><article><h3>Daily Pokémon quiz</h3><p>Identify a Pokémon from a rotating clue and check the community results.</p></article></div><h2>Pokémon dailies FAQ</h2><details><summary>Are the Pokémon daily games free?</summary><p>Yes. Pokémon Connections is playable without an account and saves progress in this browser. A free DraftCenter account is required to submit the community games, join discussions, and earn completion badges.</p></details><details><summary>When do the daily Pokémon games reset?</summary><p>Pokémon Connections, the poll, bracket, and quiz use your local calendar date, so four fresh games appear each day.</p></details><details><summary>What are DraftCenter’s Pokémon Daily Games?</summary><p>They are Pokémon Connections, one community poll, one eight-Pokémon draft bracket, and one Pokémon quiz released each day.</p></details><details><summary>When can I join a Daily Games discussion?</summary><p>Sign in and complete that day’s game first. Its discussion then opens without revealing answers before you finish.</p></details></section>
