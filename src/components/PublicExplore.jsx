...
export default function PublicExplore() {
  ...
  return <main className="explore-shell">
    ...
    <header className="explore-hero">
      <div className="public-page-nav"><a className="quiet-button community-home-link" href="/"><img src="/draftcenter-logo.png" alt="" />DraftCenter Home</a><a className="quiet-button" href="/resources/daily-games">Daily Games</a><a className="quiet-button" href="/pokemon">Pokémon</a></div>
    ...
    {data && <>
      ...
      <div className="explore-grid">
        ...
        <Ranking expandable onSelectPokemon={setSelectedPokemon} title="Highest league win rates" items={trends?.win_rates} empty="Win rates appear after Pokémon teams complete at least two confirmed matches in non-practice leagues." render={(item) => <span><strong>{item.pokemon}</strong><small>{item.win_rate}% · {item.wins}-{item.games - item.wins} across {item.games} matches · anonymous league aggregate</small></span>} />
