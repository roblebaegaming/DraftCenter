...
export default function PokemonCalendar() {
  ...
  async function load(owner) {
    ...
    if (profileResult.error || membershipResult.error) {
      setMessage((profileResult.error || membershipResult.error).message);
      return;
    }
