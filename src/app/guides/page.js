...
export const metadata = {
  ...
  description: "Practical Pokémon guides for league setup, spreadsheet migration, Showdown replay results, drafts, transactions, standings, playoffs, and team research.",
