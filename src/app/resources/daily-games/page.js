...
export const metadata = {
  title: "Pokémon Daily Games – Connections, Poll, Bracket & Quiz",
  ...
  openGraph: { title: "Pokémon Daily Games – Connections, Poll, Bracket & Quiz", description: "Play four fresh Pokémon games every day, including Pokémon Connections.", url: "/resources/daily-games", type: "website", images: [{ url: "/draftcenter-logo.png", width: 512, height: 512, alt: "DraftCenter Pokémon Daily Games" }] },
