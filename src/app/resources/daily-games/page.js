...
export default function DailyGamesPage() {
  const structuredData = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "FAQPage", mainEntity: [
      ...
      { "@type": "Question", name: "When do the daily Pokémon games reset?", acceptedAnswer: { "@type": "Answer", text: "The games use your local calendar date. The Sunday Super Bracket lineup locks after Saturday closes at midnight Pacific." } },
