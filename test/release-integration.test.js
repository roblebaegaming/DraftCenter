...
test("the full suite includes every integrated feature gate", () => {
  ...
  for (const script of ["test:nuzlocke", "test:tournaments", "test:mega-bracket", "test:public-bracket-builder", "test:multi-pod", "test:trainer-dex", "test:pokedex-tracker", "test:legends-za", "test:app-platform", "test:calendar", "test:auction-reconciliation", "test:worlds", "test:release-integration"]) {
