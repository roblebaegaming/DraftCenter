...
The separately authorized Pokédex and Alpha migrations added 364 Z-A Pokédex
entries to isolated Preview while preserving zero Z-A locations and encounters.
...
Those seven evolution outcomes are eligible for the separate Alpha Dex because
each can evolve from a directly obtainable Alpha in the same reviewed family.
That eligibility artifact exposes no location, level, probability, progression,
or encounter row and does not activate Z-A in Nuzlocke tools.
