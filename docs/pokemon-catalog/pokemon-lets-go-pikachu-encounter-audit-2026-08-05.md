# Pokémon: Let's Go, Pikachu! encounter audit
...
- Pikachu is the fixed starter. Sandshrew, Oddish, Growlithe, Mankey, Grimer, Scyther, and the Persian gift provide version-specific checks. GO Park transfers are excluded.
...
`npm run catalog:audit:lets-go-pikachu` asserts all counts, paired-version differences, the 3,040-byte/35-area PKHeX container, all 688 slots, exact tuple intersection, one-location scoping, special mechanics, and version exclusives. Migrations 320–321 are prepared but unapplied.
