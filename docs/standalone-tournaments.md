...
`340-standalone-single-elimination-tournaments.sql` must not be applied to
...
Before release, apply migration 340 to a fresh isolated Preview database and test
