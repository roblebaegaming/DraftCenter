...
`339-standalone-single-elimination-tournaments.sql` must not be applied to
...
Before release, apply migration 339 to a fresh isolated Preview database and test
